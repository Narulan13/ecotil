...
<body>
    ...
    <nav id="navbar" class="navbar-custom">
        <div class="logo left">
            <a href="index.php"><img src="img/logo_001.svg" alt="logo_ecotil"></a>
        </div>
        <div class="nav_text">
            <a href="src/course.php" class="nav_text_">Курс</a>
            <a href="src/rating.php" class="nav_text_">Рейтинг</a>
            <a href="src/newspage.php" class="nav_text_">Жаңалықтар</a>
        </div>
        <div class="right logbtn">
                <a href="src/login.php"><button class="signin">Кіру</button></a>
        </div>
        ...
        <div id="mobileNav" class="mobile-nav">
            ...
            <a href="src/rating.php" class="nav_text_">Рейтинг</a>
            <a href="src/newspage.php" class="nav_text_">Жаңалықтар</a>
            <a href="src/login.php" class="signin">Кіру</a>
        </div>
    </nav>
    ...
    <section id="top3">
        ...
        <div class="list_top3 left right">
            ...
            while ($row = mysqli_fetch_assoc($res)) {
            ?>
                <div class="card" aria-label="<?php echo ($index + 1); ?>st">
